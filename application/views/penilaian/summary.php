...
<div class="container-fluid">
    ...
    <div class="card shadow-lg mb-4 border-0">
        <div class="card-header py-3 bg-gradient-primary d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-white"><i class="fas fa-chart-bar mr-2"></i>Rekapitulasi Penilaian
                Mitra</h6>
        </div>
                    ...
                    <form action="" method="get" class="form-row align-items-center bg-light p-3 rounded border">
                            ...
                            <div class="input-group mb-2 mb-sm-0">
                                <div class="input-group-prepend">
                                    <div class="input-group-text bg-white border-right-0"><i
                                            class="far fa-calendar-alt text-primary"></i></div>
                                </div>
                                <select name="bulan" id="filterBulan" class="form-control border-left-0"
                        ...
                        <div class="col-auto">
                            ...
                            <div class="input-group mb-2 mb-sm-0">
                                <div class="input-group-prepend">
                                    <div class="input-group-text bg-white border-right-0"><i
                                            class="fas fa-calendar text-primary"></i></div>
                                </div>
                                <select name="tahun" id="filterTahun" class="form-control border-left-0"
                                    style="font-size: 0.9rem;">
                        ...
                        <div class="col-auto">
                            <div class="input-group mb-2 mb-sm-0">
                                <div class="input-group-prepend">
                                    <div class="input-group-text bg-white border-right-0"><i
                                            class="fas fa-search text-primary"></i></div>
                                </div>
                        ...
                        <div class="col-auto ml-auto">
                            <button type="submit" class="btn btn-primary px-4 shadow-sm"><i
                                    class="fas fa-filter mr-1"></i> Terapkan</button>
                            <a href="<?= base_url('penilaian'); ?>" class="btn btn-outline-secondary ml-2 shadow-sm"><i
                                    class="fas fa-redo-alt mr-1"></i> Reset</a>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered" id="dataTablePremium" width="100%" cellspacing="0">
                    <thead class="thead-light">
                        <tr>
                            <th class="align-middle text-center border-top-0 shadow-sm" style="min-width: 200px;">Nama
                                Mitra / NIK</th>
                    ...
                    <tbody>
                        <?php foreach ($mitra_summary as $ms): ?>
                            <tr>
                                <td class="align-middle" data-order="<?= $ms['nama']; ?>">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-circle mr-3 bg-gradient-light text-primary font-weight-bold d-flex justify-content-center align-items-center shadow-sm"
                                            style="width: 40px; height: 40px; border-radius: 50%;">
                                            <?= substr($ms['nama'], 0, 1); ?>
                                        </div>
                                        <div>
                                            <div class="font-weight-bold text-gray-800"><?= $ms['nama']; ?></div>
                                            <div class="small text-muted"><i class="far fa-id-card mr-1"></i>
                                                <?= $ms['nik']; ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="align-middle text-center" data-order="<?= $ms['jk']; ?>">
                                    <?php if ($ms['jk'] == '1'): ?>
                                        <span class="badge badge-pill badge-primary px-3 py-2 shadow-sm"><i
                                                class="fas fa-mars mr-1"></i> Laki-laki</span>
                                    <?php else: ?>
                                        <span class="badge badge-pill badge-info px-3 py-2 shadow-sm"><i
                                                class="fas fa-venus mr-1"></i> Perempuan</span>
                                    <?php endif; ?>
                                </td>
                                <td class="align-middle text-center" data-order="<?= $ms['total_kegiatan']; ?>">
                                    <span class="font-weight-bold text-gray-700 h5"><?= $ms['total_kegiatan']; ?></span>
                                    <div class="small text-muted">Kegiatan</div>
                                </td>
                                <td class="align-middle text-center" data-order="<?= $ms['rata_rata']; ?>">
                                    <?php if ($ms['rata_rata']): ?>
                                        <?php
                                        $nilai = $ms['rata_rata'];
                                        ...
                                        ?>
                                        <div class="h5 font-weight-bold mb-0 <?= $text_class ?>">
                                            <?= number_format($nilai, 2); ?></div>
                                        <div class="progress progress-sm mt-1" style="height: 4px; width: 60%; margin: 0 auto;">
                                            <div class="progress-bar bg-<?= str_replace('badge-', '', $badge_class) ?>"
                                                role="progressbar" style="width: <?= $nilai ?>%" aria-valuenow="<?= $nilai ?>"
                                ...
                                <td class="align-middle text-center">
                                    ...
                                    ?>
                                    <a href="<?= $link_detail; ?>"
                                        class="btn btn-sm btn-outline-primary shadow-sm rounded-circle p-2"
