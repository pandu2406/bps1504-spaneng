            ...
            <div>
                <div class="row" style="color:#00264d;">
                    ...
                    <div class="col-lg-3" align=right>
                        <a href="<?= base_url('kegiatan/pengawasterpilih/') . $kegiatan['id'] ?>" class="btn btn-danger">Kembali</a>
                        <a href="<?= base_url('kegiatan/pencacahterpilih/') . $kegiatan['id'] . '/' . $pengawas['id_peg']  ?>" class="btn btn-info">Pencacah Terpilih</a>
                    </div>
