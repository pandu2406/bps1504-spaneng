            ...
            <div>
                <div class="row mb-3" style="color:#00264d;">
                    <div class="col-lg-6" align=left>
                        <h2>
                            <?= $kegiatan['nama']; ?> (Pencacah Organik)
                        </h2>
                        <h4>Jumlah Pencacah=
                            <?= $kuota['kegiatan_id']; ?> /
                            <?= $kegiatan['k_pencacah']; ?>
                                    ...
                                    <tr align=center>
                                        <td>
                                            <div class="form-check">
                                                <input class="form-pencacah-organik-input" type="checkbox"
                                                    <?= in_array($p['id_peg'], $assigned_peg) ? "checked" : ""; ?>
                                                    data-kegiatan="<?= $kegiatan['id']; ?>"
                                                    data-pegawai="<?= $p['id_peg']; ?>">
                                            </div>
                                        </td>
                                        <td>
                                            <?= $p['nip']; ?>
                                        ...
                                        <td>
                                            <a href="<?= base_url('kegiatan/details_kegiatan_pegawai/') . $kegiatan['id'] . '/' . $p['id_peg']; ?>"
