            ...
            <div class="dropdown d-inline-block mb-3 mr-2">
                ...
                <div class="dropdown-menu">
                    ...
                    foreach ($bulan as $i => $b): ?>
                        <a class="dropdown-item" href="<?= base_url('rekap/filter_periode/' . ($i + 1) . '/' . $selected_tahun); ?>"><?= $b; ?></a>
                    <?php endforeach; ?>
                </div>
            </div>
            ...
            <div class="dropdown d-inline-block mb-3">
                ...
                <div class="dropdown-menu">
                    ...
                    for ($t = $tahun_sekarang; $t >= $tahun_sekarang - 5; $t--): ?>
                        <a class="dropdown-item" href="<?= base_url('rekap/filter_periode/' . $selected_bulan . '/' . $t); ?>">Tahun <?= $t; ?></a>
                    <?php endfor; ?>
                </div>
            </div>
